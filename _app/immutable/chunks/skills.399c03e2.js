...
Python’s adaptability allowed me to work on diverse projects across various domains, making it my primary language for development and problem-solving.`,m=`## JavaScript in My Projects
...
React.js has been an integral part of my tech stack for building interactive, fast, and maintainable web applications.`,y=`## Node.js in My Projects
...
FastAPI's performance, ease of use, and powerful features have significantly contributed to the efficiency and quality of API development in my projects.`,D=`## Django in My Projects
...
Django’s comprehensive features and robust design principles have significantly enhanced my ability to develop secure, scalable, and maintainable web applications.`,I=`## AWS in My Projects
...
NumPy's versatility and performance make it an essential tool for numerical computations and data analysis in Python.`,x=`## Firebase in My Projects
...
Firebase’s comprehensive set of tools and services significantly simplifies the development process, providing robust backend support and real-time capabilities for modern applications.`,C=`## SolidWorks in My Projects
...
MySQL's robust features and capabilities make it a versatile choice for managing relational data, providing reliable and efficient data management solutions for various applications and projects.`,R=`## Go in My Projects
### Alter Cabs
...
PHP’s versatility and extensive features make it a robust choice for web development, supporting a wide range of applications from small projects to large-scale systems.`,q="",B="",U=`## C++ in My Projects
...
C++ has been fundamental in achieving the high performance and efficiency required for real-time 4D medical volume rendering while maintaining precise control over system resources.`,N=`## MATLAB in My Projects
...
Qt has been crucial in creating an intuitive and powerful user interface for medical professionals to interact with complex 4D volumetric data, while maintaining professional standards required for medical software.`;function Q(i,...t){const o=Object.assign({},i);return Object.keys(o).forEach(s=>{t.includes(s)&&delete o[s]}),o}const a=i=>i,W=[a({name:"Programming Languages",slug:"pro-lang"}),a({name:"Frameworks",slug:"framework"}),a({name:"Libraries",slug:"library"}),a({name:"Langauges",slug:"lang"}),a({name:"Databases",slug:"db"}),a({name:"ORMs",slug:"orm"}),a({name:"DevOps",slug:"devops"}),a({name:"Testing",slug:"test"}),a({name:"Dev Tools",slug:"devtools"}),a({name:"Markup & Style",slug:"markup-style"}),a({name:"Design",slug:"design"}),a({name:"Soft Skills",slug:"soft"}),a({name:"Environments & Runtime",slug:"env"})],n=i=>{const t=Q(i,"category");return i.category&&(t.category=W.find(o=>o.slug===i.category)),t},d=[n({slug:"js",color:"yellow",description:m,logo:e.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"ts",color:"blue",description:u,logo:e.TypeScript,name:"Typescript",category:"pro-lang"}),n({slug:"css",color:"blue",description:"Level of Eexpertise : 7/10",logo:e.CSS,name:"CSS",category:"markup-style"}),n({slug:"html",color:"orange",description:"Level of Eexpertise : 8/10",logo:e.HTML,name:"HTML",category:"markup-style"}),n({slug:"sass",color:"pink",description:"Level of Eexpertise : 6/10",logo:e.Sass,name:"Sass",category:"markup-style"}),n({slug:"reactjs",color:"cyan",description:h,logo:e.ReactJs,name:"React Js",category:"library"}),n({slug:"svelte",color:"orange",description:p,logo:e.Svelte,name:"Svelte",category:"library"}),n({slug:"python",color:"orange",description:g,logo:e.Python,name:"Python",category:"pro-lang"}),n({slug:"cpp",color:"orange",description:U,logo:e.Cpp,name:"C++",category:"pro-lang"}),n({slug:"nodejs",color:"orange",description:y,logo:e.NodeJs,name:"Node Js",category:"env"}),n({slug:"expressjs",color:"orange",description:v,logo:e.ExpressJs,name:"Express Js",category:"framework"}),n({slug:"mongodb",color:"orange",description:b,logo:e.MongoDB,name:"MongoDB",category:"db"}),n({slug:"postgresql",color:"orange",description:w,logo:e.PostgreSQL,name:"PostgreSQL",category:"db"}),n({slug:"redis",color:"orange",description:k,logo:e.Redis,name:"Redis",category:"db"}),n({slug:"docker",color:"orange",description:P,logo:e.Docker,name:"Docker",category:"devops"}),n({slug:"aws",color:"orange",description:I,logo:e.AWS,name:"AWS",category:"devops"}),n({slug:"fastapi",color:"orange",description:j,logo:e.FastApi,name:"Fast Api",category:"framework"}),n({slug:"matlab",color:"orange",description:N,logo:e.Matlab,name:"Matlab",category:"env"}),n({slug:"qt",color:"orange",description:O,logo:e.Qt,name:"Qt",category:"env"}),n({slug:"django",color:"orange",description:D,logo:e.Django,name:"Django",category:"framework"}),n({slug:"flask",color:"orange",description:S,logo:e.Flask,name:"Flask",category:"framework"}),n({slug:"vite",color:"orange",description:A,logo:e.Vite,name:"Vite",category:"devtools"}),n({slug:"tailwind",color:"orange",description:f,logo:e.Tailwind,name:"Tailwind",category:"markup-style"}),n({slug:"bootstrap",color:"orange",description:"Level of Eexpertise : 8/10",logo:e.Bootstrap,name:"Bootstrap",category:"markup-style"}),n({slug:"pandas",color:"orange",description:M,logo:e.Pandas,name:"Pandas",category:"library"}),n({slug:"numpy",color:"orange",description:z,logo:e.Numpy,name:"Numpy",category:"library"}),n({slug:"firebase",color:"orange",description:x,logo:e.Firebase,name:"Firebase",category:"db"}),n({slug:"solidworks",color:"orange",description:C,logo:e.SolidWorks,name:"SolidWorks",category:"design"}),n({slug:"mysql",color:"orange",description:T,logo:e.MySQL,name:"MySQL",category:"db"}),n({slug:"go",color:"orange",description:R,logo:e.Go,name:"Go",category:"pro-lang"}),n({slug:"android",color:"orange",description:E,logo:e.Android,name:"Android",category:"env"}),n({slug:"tensorflow",color:"orange",description:L,logo:e.Tensorflow,name:"Tensorflow",category:"library"}),n({slug:"php",color:"orange",description:F,logo:e.PHP,name:"PHP",category:"pro-lang"}),n({slug:"java",color:"orange",description:q,logo:e.Java,name:"Java",category:"pro-lang"}),n({slug:"solidity",color:"orange",description:B,logo:e.solidity,name:"Solidity",category:"pro-lang"})],J="Skills",G=(...i)=>d.filter(t=>i.includes(t.slug)),V=i=>{const t=[],o=[];return d.forEach(s=>{if(i.trim()&&!s.name.toLowerCase().includes(i.trim().toLowerCase()))return;if(!s.category){o.push(s);return}let r=t.find(c=>{var l;return c.category.slug===((l=s.category)==null?void 0:l.slug)});r||(r={items:[],category:s.category},t.push(r)),r.items.push(s)}),o.length!==0&&t.push({category:{name:"Others",slug:"others"},items:o}),t};export{V as a,G as g,d as i,J as t};

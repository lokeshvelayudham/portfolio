import{A as e}from"./UIcon.3e196951.js";import{g as a}from"./skills.73c721e7.js";const n=[{slug:"stainviz",color:"#0f766e",description:`# StainViz - AI Virtual Staining for Histology
...
StainViz sits at the intersection of digital pathology, biomedical imaging, and applied AI. The work reduces repeated chemical staining pressure, improves tissue analysis throughput, and creates a more scalable path for stain-free microscopy workflows.`,shortDescription:"AI virtual staining workflows for stain-free histology and fluorescence microscopy, featured in a first-author Cytotherapy publication.",links:[{to:"https://doi.org/10.1016/j.jcyt.2026.102158",label:"DOI"},{to:"https://www.sciencedirect.com/science/article/abs/pii/S1465324926001192",label:"ScienceDirect"}],logo:e.BioInVision,name:"StainViz",period:{from:new Date(2025,0,1)},skills:a("python","tensorflow","numpy","docker","fastapi","ai-ml","medical-imaging"),type:"AI Medical Imaging Research",screenshots:[{label:"Brightfield input to AI-inferred H&E",src:e.StainVizPublication}]},{slug:"stratum-labs",color:"#ef6f51",description:`# Stratum Labs - Autonomous CRM and Enterprise Platform
...
The platform is built as a serious operating layer for revenue execution: organization-level workspaces, user roles, autonomous swarm agents, lead scoring, revenue attribution, agent memory, and inbox classification. The goal is to turn GTM work into measured systems with explicit capital allocation and observable outcomes.`,shortDescription:"An autonomous CRM and enterprise platform for deploying revenue agents, tracking telemetry, and reallocating GTM capital by ROI.",links:[{to:"https://www.stratumlabs.app/",label:"Live Product"}],logo:e.StratumLabs,name:"Stratum Labs",period:{from:new Date(2026,4,1)},skills:a("ts","reactjs","nextjs","nodejs","postgresql","mongodb","redis","aws","docker","saas"),type:"Autonomous CRM Platform",screenshots:[]},{slug:"cryo-viz-web",color:"#ff3e00",description:`# CryoViz Web - Medical Imaging Platform
...
The architecture is designed for long-term scalability and maintainability, ensuring the platform can evolve with advancing medical imaging technologies and growing user demands.`,shortDescription:"A high-performance, real-time medical imaging review platform for cryo-electron microscopy (cryo-EM) datasets.",links:[{to:"https://cryo-viz-web.vercel.app/",label:"Live Demo"},{to:"https://github.com/lokeshvelayudham/cryoVizWeb",label:"GitHub"}],logo:e.BioInVision,name:"CryoViz Web",period:{from:new Date(2025,0,1)},skills:a("reactjs","python","mongodb","docker","fastapi","nextjs","webgl","azure","async","streaming","vtk"),type:"Web-based Medical Imaging Platform",screenshots:[]},{slug:"ischemia-viz",color:"#ff3e00",description:`# IschemiaViz - 3D Medical Imaging Viewer
...
The architecture is designed for clinical deployment and research applications, ensuring the platform can evolve with advancing medical imaging technologies and growing clinical demands.`,shortDescription:"A high-performance 3D medical imaging viewer with proprietary ABHC algorithms for automated ischemia detection and real-time perfusion analysis.",links:[{to:"#",label:"Internal Platform"},{to:"https://github.com/lokeshvelayudham",label:"GitHub"}],logo:e.BioInVision,name:"IschemiaViz",period:{from:new Date(2025,0,1)},skills:a("cpp","python","qt","opengl","dicom","nifti","opencv"),type:"3D Medical Imaging Platform",screenshots:[]},{slug:"tissue-rem",color:"#ff3e00",description:`# TissueReM - AI-Powered Virtual Staining Platform
...
The architecture is designed for clinical deployment and research applications, ensuring the platform can evolve with advancing AI/ML technologies and growing clinical demands.`,shortDescription:"An AI-powered virtual staining platform using deep learning, mixed-precision inference, and multi-GPU acceleration to transform unstained tissue samples.",links:[{to:"#",label:"Internal Platform"},{to:"https://github.com/lokeshvelayudham",label:"GitHub"}],logo:e.BioInVision,name:"TissueReM",period:{from:new Date(2025,0,1)},skills:a("python","pytorch","tensorflow","opencv","numpy","gpu","ai-ml","deep-learning"),type:"AI-Powered Medical Imaging Platform",screenshots:[]},{slug:"intersection",color:"#ff3e00",description:`# Intersection - AI-Assisted Judge-Student Matching Platform
...
The architecture is designed for academic and research applications, ensuring the platform can evolve with advancing AI/ML technologies and growing event management demands.`,shortDescription:"An AI-assisted judge-student matching platform that automates the entire process from registration to pairing, reducing setup time from days to minutes.",links:[{to:"https://github.com/lokeshvelayudham/intersection",label:"GitHub"}],logo:e.CWRU,name:"Intersection",period:{from:new Date(2024,1,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs","ts","mysql","aws"),type:"AI-Powered Event Management Platform",screenshots:[{label:"1",src:e.IntersectionScreenshot1},{label:"2",src:e.IntersectionScreenshot2}]},{slug:"halo-harbour",color:"#ff3e00",description:`Technical Description: 
...
AWS Nitro Enclaves provide isolated execution environments for secure data computation, enhancing privacy and control.`,shortDescription:"Halo Harbor is a decentralized application that empowers users with control over their data privacy and usage, utilizing a secure vault for data management.",links:[{to:"https://haloharbor.io/",label:"haloHarbour"},{to:"https://github.com/cwru-xlab/Consolidated_Progressive",label:"github"}],logo:e.HaloHarbour,name:"Halo Harbour",period:{from:new Date(2024,7,1)},skills:a("mongodb","js","postgresql","reactjs","java","aws","python","docker"),type:"Decentralized Development",screenshots:[{label:" 1",src:e.HaloHarbourScreenshot1},{label:"2",src:e.HaloHarbourScreenshot2},{label:"3",src:e.HaloHarbourScreenshot3}]},{slug:"gitCraft",color:"#ff3e00",description:`Technical Description: 
...
3. The application is hosted with Render for the backend and Netlify for the frontend, ensuring reliable deployment and hosting. CI/CD pipelines are configured using Netlify to automate the build and deployment process. The platform also incorporates PlayWright for end-to-end testing, ensuring a stable and bug-free user experience. API documentation is available through Swagger, providing clear guidelines for integrating and extending the application's capabilities.`,shortDescription:"Developed a web-based platform with user authentication, enabling a dynamic community feed for sharing and forking multimedia crafting posts, along with private repositories for personalized post management.",links:[{to:"https://merry-khapse-6dd1d8.netlify.app",label:"gitCraft"},{to:"https://github.com/cwru-courses/summer2024_csds393_group2",label:"github"}],logo:e.gitCraft,name:"gitCraft",period:{from:new Date(2024,5,1),to:new Date(2024,7,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs"),type:"fullstack Development",screenshots:[{label:"screen 1",src:e.gitCraftScreenshot4},{label:"2",src:e.gitCraftScreenshot2},{label:"3",src:e.gitCraftScreenshot1}]},{slug:"alter-cabs",color:"#5e95e3",description:`Alter Cabs was born—a beacon of change, a tribute to the drivers who weave tales of the road, and a testament to the power of alternatives. The name "Alter" symbolised the transformation they sought to bring, and "Cabs" spoke of the fundamental service they aimed to improve .
 ...
 To redefine urban travel with premium, reliable, and transparent ride-hailing solutions.`,shortDescription:"As the app hit the streets, it wasn't just another ride-hailing service. It was a movement—a revolution driven by drivers, embraced by passengers, and admired by all who sought a different kind of ride.",links:[{to:"https://www.altercabs.com/",label:"altercabs"},{to:"https://bx-bb-mobile-wrappers.s3.amazonaws.com/546270/master/0.1.94_Android_release.apk",label:"Android APK"}],logo:e.AlterCabs,name:"Alter Cabs",period:{from:new Date(2023,5,1)},skills:a("reactjs","ts","tailwind","js","android"),type:"Android and iOS Application",screenshots:[{label:"screen 1",src:e.AlterCabsScreenshot1},{label:"2",src:e.AlterCabsScreenshot2},{label:"3",src:e.AlterCabsScreenshot3},{label:"4",src:e.AlterCabsScreenshot4},{label:"5",src:e.AlterCabsScreenshot5}]},{slug:"pct",color:"#ff3e00",description:`Technical Description: 
	...
	•	Volume Target: Aims to capture 1% of the daily $500M trading volume on DEXs like GMX and DYDX.`,shortDescription:"A service that allows users to copy trades from top whales across various DEXs and CEX futures, leveraging smart contracts and decentralized technology.",links:[{to:"https://github.com/lokeshvelayudham/PerpCopyTrading",label:"github"}],logo:e.PerpCopyTrading,name:"Perpetual Copy Trading",period:{from:new Date(2022,0,1),to:new Date(2022,10,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs","solidity"),type:"Web3 Full stack Development",screenshots:[]},{slug:"foox",color:"#ff3e00",description:`Technical Description: 
...
3. Foox Technologies secured ₹4.5M in funding and generated ₹0.75 crore in revenue within 6 months.`,shortDescription:"Co-founded and developed a B2B HoReCa platform using the MERN stack, improving search efficiency by 30% and generating ₹0.75 crore revenue in 6 months.",links:[{to:"https://www.instagram.com/foox.in?igsh=dnl5c3l2dTNveGo=",label:"foox"},{to:"https://github.com/lokeshvelayudham",label:"github"}],logo:e.FooxTechnologies,name:"foox",period:{from:new Date(2021,5,1),to:new Date(2022,9,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs"),type:"fullstack Development",screenshots:[{label:"screen 1",src:e.FooxTechnologiesScreenshot1},{label:"2",src:e.FooxTechnologiesScreenshot2}]},{slug:"go-kart",color:"#ff3e00",description:`	1. Turbo Knights is a Chennai-based go-kart focused on designing and producing high-performance, safe, and reliable go-karts for racing and recreational use. 
				2. Drawing inspiration from Formula One, the team employs innovative and practical design techniques.
				3. The go-karts are engineered for durability, safety, and performance, making them suitable for both enthusiasts and professionals.`,shortDescription:"Building high-performance go-karts inspired by Formula One as part of the Turbo Knights team, racing across India.",links:[{to:"https://www.instagram.com/turbo_knights_official/",label:"turboKnights"}],logo:e.TurboKnights,name:"Turbo Knights",period:{from:new Date(2015,5,1),to:new Date(2017,7,1)},skills:a("solidworks"),type:"Manufacturing Design",screenshots:[{label:"screen 1",src:e.TurboKnightsScreenshot1},{label:"2",src:e.TurboKnightsScreenshot2}]},{slug:"gUSD",color:"#ff3e00",description:`1. gUSD is a decentralized, trustless stablecoin backed by synthetic gold, allowing users to lock any token (ETH, BTC, or stablecoins) as collateral, which is then converted into gold pricing. 
	...
	3. Users can mint or burn gUSD based on their actions, ensuring transparency and decentralization while avoiding centralized gold-backed tokens.`,shortDescription:"Mint gUSD, a decentralized stablecoin backed by synthetic gold, allowing users to safely hedge against volatility and leverage up to 50x with minimal risk.",links:[{to:"https://spiced-drawbridge-1d9.notion.site/gUSD-Litepaper-fbdda3ec043e4c4ebb0c17fc26878ef9",label:"gUSD White paper"}],logo:e.gUSD,name:"gUSD",period:{from:new Date(2018,5,1),to:new Date(2019,7,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs","solidity"),type:"Web3 Full stack Development",screenshots:[]},{slug:"guvi",color:"#ff3e00",description:"GuviGeek Technologies, an IIT-M and IIM-A incubated EdTech platform, focuses on vernacular upskilling with a global learner base of over 3 million. I contributed by developing a PHP hiring module that streamlined recruitment processes for 50+ employers, improving system performance by 25% and boosting company revenue by 15%.",shortDescription:"Developed a PHP-based hiring module with integrated microservices, improving system performance and enhancing recruitment processes for 1000+ students.",links:[{to:"https://www.guvi.in/",label:"GVUI"}],logo:e.GUVI,name:"Guvi - Hiring Module",period:{from:new Date(2019,1,1),to:new Date(2019,5,1)},skills:a("mongodb","js","nodejs","expressjs","reactjs","ts","mysql"),type:"Backend Development",screenshots:[{label:"screen 1",src:e.GuviScreeshot1},{label:"2",src:e.GuviScreeshot2},{label:"3",src:e.GuviScreeshot3}]},{slug:"portfolo",color:"#ff3e00",description:`Technical Description: 
...
`,shortDescription:"A personal portfolio website built with Svelte and SvelteKit, showcasing projects, skills, and experience.",links:[{to:"https://lokeshvelayudham.github.io/portfolio/",label:"lokesh Velayudham"},{to:"https://github.com/lokeshvelayudham/portfolio",label:"github"}],logo:e.Portfolio,name:"Portfolio Website",period:{from:new Date(2024,8,10),to:new Date(2024,8,15)},skills:a("svelte","js","ts","html","sass"),type:"frontend Development",screenshots:[{label:"screen 1",src:e.PortfolioScreenshot1},{label:"2",src:e.PortfolioScreenshot2},{label:"3",src:e.PortfolioScreenshot3}]}],o="Projects";export{n as i,o as t};

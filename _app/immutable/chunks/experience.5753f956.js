...
3. Clinical Interface: Developed using Qt framework, offering an intuitive GUI with specialized medical visualization tools, including synchronized multi-planar views, custom transfer function editors, and DICOM series navigation. Features comprehensive measurement tools and annotation systems for detailed medical analysis.`,contract:i.FullTime,type:"Software Development",location:"Cleveland, OH",period:{from:new Date(2025,0,1)},skills:n("cpp","python","matlab","medical imaging","qt"),name:"Software Developer ",color:"red",links:[],logo:e.BioInVision,shortDescription:"4D render Imaging Software for Computed Tomograpty"},{slug:"open-sourcer",company:"Case Western Reserve University",description:`• Developed full-stack registration app using MERN stack with dashboards for students, judges, and admins.
...
• This led to a 15% increase in company revenue through improved recruitment processes and interactions.`,contract:i.FullTime,type:"Web Developer",location:"Chennai, India",period:{from:new Date(2018,0,1),to:new Date(2018,11,1)},skills:n("python","reactjs","nodejs","expressjs","mysql","mongodb","php"),name:"Web Developer ",color:"green",links:[],logo:e.Beyondx,shortDescription:"Developed innovative web-based LMS and VR/AR solutions, enhancing interactive learning experiences and ensuring seamless technology integration."}],r="Experience";export{s as i,r as t};
